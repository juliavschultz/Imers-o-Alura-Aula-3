...
public class gerarFigurinha {
    ...
    public void criar (InputStream inputStream, String nomeArquivo) throws Exception{
        ...
        //configurar fonte
        var fonte = new Font(Font.SERIF, Font.BOLD, 50); //fonte, italico/negrito, tamanho 
        graphics.setColor(Color.RED); //aplica no grafico
        graphics.setFont(fonte); //aplica a var fonte

        //ESCREVER UMA FRASE NA NOVA IMAGEM
        graphics.drawString("Julia aprendendo JAVA", 50, novaAltura-50); //o que é escrito, posiçãoX, posiçãoY
